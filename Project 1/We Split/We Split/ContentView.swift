...
struct ContentView: View {
    ...
    var AmountWithTip: Double {
        ...
        let fullAmountWithTip = checkAmount + tipValue
        
        return fullAmountWithTip
    }
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("Amount plus tip") {
                    Text(AmountWithTip, format: .currency(code: Locale.current.currency?.identifier ?? "EUR"))
                }
